...
/**
 * @brief Gets a response frame from the Model if one is ready
 *
 * Responses are generated by calls to @ProtocolModel_ReceiveFrame.
 *
 * The response is reset after this function is called, so only one copy is
 * available.
 *
